      ...
      <section className="section hero">
        <div className="section__inner" style={{ paddingTop: '5rem', paddingBottom: '2rem' }}>
          <div className="container">
            <h1 className="heading-xl hero-title" style={{ opacity: 0 }}>Join the Movement</h1>
          ...
          <div className="container">
            <div className="grid-2">
              <div className="glass-card">
                ...
                <Link to="/contact" className="btn-primary" data-cursor-hover>Apply to Volunteer</Link>
              </div>
              <div className="glass-card">
                ...
                <Link to="/contact" className="btn-outline" data-cursor-hover>Make a Donation</Link>
              </div>
              <div className="glass-card">
                ...
                <Link to="/contact" className="btn-outline" data-cursor-hover>Discuss Partnership</Link>
              </div>
              <div className="glass-card">
                ...
                <div className="btn-group">
                  <a href="#" className="btn-outline" style={{ padding: '0.75rem 1.5rem' }} data-cursor-hover>Instagram</a>
                  <a href="#" className="btn-outline" style={{ padding: '0.75rem 1.5rem' }} data-cursor-hover>Twitter</a>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="section section--dark section-transition">
        <div className="section__inner">
          <div className="container" style={{ maxWidth: '800px' }}>
            <h2 className="heading-lg reveal-up text-serif" style={{ textAlign: 'center', marginBottom: '3rem' }}>FAQ</h2>
            <div className="glass-card">
