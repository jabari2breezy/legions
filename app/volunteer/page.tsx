  ...
  return (
    <main>
      ...
      <section className="container-narrow" style={{ paddingTop: "var(--space-section)", paddingBottom: "var(--space-block)" }}>
        <span className="stat-label" style={{ color: "var(--color-text-secondary)", display: "block", marginBottom: "12px" }}>Join Us</span>
      ...
      <section className="container-narrow" style={{ paddingTop: "var(--space-section)" }}>
        <span className="stat-label" style={{ color: "var(--color-text-secondary)", display: "block", marginBottom: "12px" }}>The Standard</span>
        ...
        <form style={{ maxWidth: "700px", display: "flex", flexDirection: "column", gap: "20px" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            <div className="form-field">
              ...
              <input id="vol-name" type="text" className="input" />
            </div>
            <div className="form-field">
              <label htmlFor="vol-email">Email</label>
              <input id="vol-email" type="email" className="input" />
            </div>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px" }}>
            <div className="form-field">
              <label htmlFor="vol-school">School / University</label>
              <input id="vol-school" type="text" className="input" />
            </div>
            <div className="form-field">
              <label htmlFor="vol-age">Age</label>
              <input id="vol-age" type="number" className="input" />
            </div>
          </div>
          <div className="form-field">
            <label htmlFor="vol-why">Why do you want to join Legions?</label>
            <textarea id="vol-why" rows={4} className="input" />
          </div>
          <div>
