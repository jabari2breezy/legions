...
interface ProjectCardProps extends Omit<HTMLMotionProps<'button'>, 'children'> {
  project: Project;
  layoutId: string;
  onOpen: () => void;
  index: number;
...
export function ProjectCard({ project, layoutId, onOpen, index, className = '', ...props }: ProjectCardProps) {
