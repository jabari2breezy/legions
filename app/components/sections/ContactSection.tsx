    ...
    >
      <div ref={elementsRef} className="relative z-10 w-full max-w-2xl px-6 md:px-12 text-center">
        ...
        <div data-contact-element className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          >
            <button className="liquid-glass px-10 py-5 rounded-full text-white/80 font-medium text-sm uppercase tracking-wider border border-white/20 hover:border-[var(--color-accent-cyan)] hover:text-white transition-colors duration-300">
              Partner With Us
            </button>
          </MagneticButton>
        </div>
