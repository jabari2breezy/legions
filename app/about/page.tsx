...
export default function About() {
  ...
  return (
    <main ref={mainRef} className="min-h-screen bg-[var(--color-bg-deep)]">
      ...
      {/* Stats */}
      <section className="py-[var(--spacing-section-y)] bg-[var(--color-surface)] border-y border-[var(--color-border-subtle)] relative">
      ...
      {/* Timeline */}
      <section className="py-[var(--spacing-section-y)] relative border-t border-[var(--color-border-subtle)] bg-[var(--color-bg-deep)] overflow-hidden">
