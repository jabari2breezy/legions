        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "clamp(32px, 5vw, 80px)", alignItems: "start" }}>
          <div>
            ...
            <ul style={{ listStyle: "none", padding: 0, display: "flex", flexDirection: "column", gap: "16px", color: "var(--color-text-secondary)" }}>
              <li style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <span style={{ color: "var(--color-accent-teal)" }}>&#10003;</span> Tax-deductible receipts available
              </li>
              <li style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <span style={{ color: "var(--color-accent-teal)" }}>&#10003;</span> Detailed post-project impact reports
              </li>
              <li style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <span style={{ color: "var(--color-accent-teal)" }}>&#10003;</span> Brand visibility across our network
              </li>
            </ul>
          </div>
          <form style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div className="form-field">
              ...
              <input id="partner-org" type="text" className="input" />
            </div>
            <div className="form-field">
              <label htmlFor="partner-contact">Contact Person</label>
              <input id="partner-contact" type="text" className="input" />
            </div>
            <div className="form-field">
              <label htmlFor="partner-email">Email Address</label>
              <input id="partner-email" type="email" className="input" />
            </div>
            <div className="form-field">
              <label htmlFor="partner-message">How would you like to partner?</label>
              <textarea id="partner-message" rows={4} className="input" />
            </div>
            <div>
